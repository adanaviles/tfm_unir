...
def create_final_dataset(train_or_test: str):
    ...
    time_columns = ["last_login", "first_login", "registration_init_time", "first_transaction", "last_transaction"]
    ...
    final_df["days_since_registration"] = (pd.to_datetime("2017-03-31") - final_df["registration_init_time"]).dt.days
...
if __name__ == "__main__":
    df_train = create_final_dataset(train_or_test="train")
    df_test = create_final_dataset(train_or_test="test")
